 ...
 * Serverless instances are recycled, so this is a speed bump, not a wall.
 * It stops a bored visitor hammering the form. For anything stronger, put
 * Vercel's WAF or an Upstash Redis counter in front of it.
 * ------------------------------------------------------------------------*/
